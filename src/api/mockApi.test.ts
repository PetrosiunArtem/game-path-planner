...
describe('Path Planner Logic (AI Advisor)', () => {
    ...
    const mockLoadouts: Loadout[] = [
        { id: 'l1', name: 'Root Buster', weaponPrimary: 'Peashooter', weaponSecondary: 'Spread', charm: 'Smoke Bomb', superMove: 'Energy Beam' },
        { id: 'l2', name: 'Wrong Tool', weaponPrimary: 'Charge', weaponSecondary: 'Roundabout', charm: 'Heart', superMove: 'Invincibility' }
    ];
